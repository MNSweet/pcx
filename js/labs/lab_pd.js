...
if(PCX.preferedUserMode()) {
	...
	DXRESULTS.setRaceTranslation({
		...
		"Mixed Race"		: ["Not Specified",		"Unknown"],
		"Mixed"				: ["Not Specified",		"Unknown"],
		"Asian"				: ["Not Specified",		"Asian"],
		"Native American"	: ["Not Specified",		"Native American"],
	...
	if(isOrderPage) {
		const selectors = {
			...
			Orientation  	: '#ContentPlaceHolder1_ddlSO [value="Not Provided"]',
			Gender			: '#ContentPlaceHolder1_rblGender',
			Ethnicity		: 	{
				"Hispanic/Latino"		: '#ContentPlaceHolder1_rdrace [value="Hispanic/Latino"]',
				"Not Specified"			: '#ContentPlaceHolder1_rdrace [value="Not Specified"]'},
			Race		: 	{
				"Asian"					: '#ContentPlaceHolder1_rdethnicity_0',
				"African American"		: '#ContentPlaceHolder1_rdethnicity_1',
				"Caucasian"				: '#ContentPlaceHolder1_rdethnicity_2',
				"Jewish (Ashkenzai)"	: '#ContentPlaceHolder1_rdethnicity_2',
				"Native American"		: '#ContentPlaceHolder1_rdethnicity_3',
				"Unknown"				: '#ContentPlaceHolder1_rdethnicity_5',
				"Other"					: '#ContentPlaceHolder1_rdethnicity_7'},
